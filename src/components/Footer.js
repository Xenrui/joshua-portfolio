...
const Footer = () => {
	return (
		<footer className="bg-black/40 w-full">
			<div className="max-w-5xl py-15 px-8 mx-auto">
				<div className="grid grid-cols-2">
					<div className="text-3xl">Joshua Delos Reyes</div>
					<div className="flex justify-end items-center gap-5 text-xs">
						<a href="#hero" className="hover:scale-110">Home</a>
						<a href="#projects" className="hover:scale-110">Projects</a>
						<a href="#technologies" className="hover:scale-110">Technologies</a>
						<a href="#blogs" className="hover:scale-110">Blogs</a>
